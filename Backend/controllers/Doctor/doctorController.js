...
exports.getDoctorsBySpecialization = async (req, res) => {
  try {
    const doctors =
      await doctorService.getDoctorsBySpecialization(
        req.params.specialization
      );
...
exports.getDoctorsByExperience = async (req, res) => {
  try {
    ...
    const doctors =
      await doctorService.getDoctorsByExperience(
        parseInt(minExperience)
      );
...
exports.updateConsultationFee = async (req, res) => {
  try {
    ...
    const doctor =
      await doctorService.updateConsultationFee(
        req.params.doctorId,
        opdFee,
        emergencyFee
      );
...
exports.getDoctorStats = async (req, res) => {
  try {
    const stats =
      await doctorService.getDoctorStats(
        req.params.doctorId
      );
