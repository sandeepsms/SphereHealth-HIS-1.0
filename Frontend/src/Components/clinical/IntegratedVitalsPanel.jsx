      ...
      <div style={{ background: C.card, border: `1.5px solid ${C.border}`, borderRadius: 12, overflow: "hidden" }}>
        ...
        <div style={{ padding: "16px 18px", display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "120px 1fr 1fr 1fr 1fr", gap: 10 }}>
            ...
            <div>
              <label style={lbl}>Systolic BP (mmHg)</label>
              <input type="number" style={{ ...fld, borderColor: isAbnormal("sbp", entry.bp_sys) ? C.red : "#e2e8f0" }}
                placeholder="120" value={entry.bp_sys} onChange={e => setE("bp_sys", e.target.value)} />
            </div>
            <div>
              <label style={lbl}>Diastolic BP (mmHg)</label>
              <input type="number" style={{ ...fld, borderColor: isAbnormal("dbp", entry.bp_dia) ? C.red : "#e2e8f0" }}
