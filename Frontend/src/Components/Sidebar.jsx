...
const NAV = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "OPD Assessment",         icon: "pi-file",                path: "/opd-assessment" },
  ...
  },
  {
    ...
    nabh: true,
    items: [
      { label: "Daily Assessment",        icon: "pi-calendar-plus",           path: "/daily-nursing-assessment",  nabh: true },
      { label: "Initial Assessment",      icon: "pi-clipboard",               path: "/nurse-initial-assessment",  nabh: true },
      { label: "Care Plan",               icon: "pi-heart-fill",              path: "/nursing-care-plan",         nabh: true },
      { label: "Handover Notes",          icon: "pi-arrow-right-arrow-left",  path: "/nursing-handover-notes",    nabh: true },
      { label: "Fall Risk Assessment",    icon: "pi-exclamation-triangle",    path: "/fall-risk-assessment",      nabh: true },
      { label: "Pressure Area Care",      icon: "pi-map-marker",              path: "/pressure-area-care",        nabh: true },
      { label: "Pain Assessment",         icon: "pi-chart-line",              path: "/pain-assessment",           nabh: true },
      { label: "Nutritional Assessment",  icon: "pi-apple",                   path: "/nutritional-assessment",    nabh: true },
      { label: "Patient Education",       icon: "pi-book",                    path: "/patient-education",         nabh: true },
      { label: "Nursing Notes",           icon: "pi-file-edit",               path: "/nursing-notes" },
      { label: "OPD Queue",               icon: "pi-list",                    path: "/opd-queue" },
