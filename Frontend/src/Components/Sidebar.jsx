...
const MENU = [
  ...
  },
  {
    ...
    roles: R.ALL,
    items: [
      { label: "IPD Admission",   icon: "pi-plus-circle",  path: "/ipd-admission",    roles: R.RECEPT, badge: "NEW" },
      { label: "Registration",    icon: "pi-user-plus",    path: "/registration/ipd", roles: R.RECEPT },
      { label: "Patient List",    icon: "pi-list",         path: "/allpatient",       roles: R.ALL },
      { label: "Patient Records", icon: "pi-id-card",      path: "/patients",         roles: R.ALL },
    ],
  },
  {
    key: "opd",
    ...
    roles: R.ALL,
    items: [
      { label: "OPD Visits",  icon: "pi-calendar",          path: "/opd-visit",  roles: R.ALL },
      { label: "New OPD",     icon: "pi-plus-circle",        path: "/opd/new",    roles: R.RECEPT },
      { label: "Emergency",   icon: "pi-bolt",               path: "/emergency",  roles: R.ALL, badge: "URGENT" },
    ],
  },
  {
    key: "doctor",
    ...
    items: [
      ...
      { label: "Prescriptions",          icon: "pi-book",                 path: "/doctors",               roles: R.DOCTOR },
  ...
  },
  {
    ...
    roles: R.NURSE,
    items: [
      { label: "Initial Assessment", icon: "pi-clipboard",              path: "/nurse-initial-assessment", roles: R.NURSE, badge: "NABH" },
      { label: "Nursing Notes",      icon: "pi-pencil",                 path: "/nursing-notes",            roles: R.NURSE },
      { label: "Care Plan",          icon: "pi-heart-fill",             path: "/nursing-care-plan",        roles: R.NURSE },
      { label: "Handover Notes",     icon: "pi-arrow-right-arrow-left", path: "/nursing-handover-notes",   roles: R.NURSE },
  ...
  },
  {
    ...
    roles: R.NURSE,
    items: [
      { label: "Update Vitals", icon: "pi-plus",       path: "/updateVitalSheet", roles: R.NURSE },
  ...
  },
  {
    ...
    roles: R.RECEPT,
    items: [
      { label: "Manage Beds",       icon: "pi-list",    path: "/beds",         roles: R.RECEPT },
      { label: "Bed Visual Layout", icon: "pi-map",     path: "/bed-visual",   roles: R.ALL },
      { label: "Wards",             icon: "pi-building", path: "/wards",        roles: R.RECEPT },
      { label: "Rooms",             icon: "pi-box",     path: "/rooms",        roles: R.RECEPT },
