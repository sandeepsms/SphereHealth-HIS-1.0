...
// R7cb-C: settings-driven hospital name in the printed report footer.
...
const BedMonthlyReportPage = () => {
  ...
  // R7cb-C: replace hardcoded "Generated by SphereHealth HIS" footer
  // with a settings-driven attribution.
      ...
      {data && !loading && (
        <div className="report-paper" style={{
          ...
          <div style={{ marginTop: 36, paddingTop: 14, borderTop: "1px dashed #cbd5e1", display: "flex", justifyContent: "space-between", fontSize: 10, color: "#64748b" }}>
            <span>Generated · {settings.hospitalName || "Hospital"} · NABH 5th Edition</span>
