...
// R7hr — the consolidated bill's hand-rolled `.hd` masthead is replaced by the
// ONE shared canonical letterhead so it matches every other document.
...
export default function ReceptionBilling() {
  ...
  const printConsolidatedFinalBill = async (billsIn, advancesIn) => {
    ...
    // _hospName stays for the "Generated by … HIS" footer note below.
